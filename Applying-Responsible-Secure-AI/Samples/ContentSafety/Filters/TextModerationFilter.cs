...
/// </summary>
public class TextModerationFilter(ContentSafetyClient contentSafetyClient) : IPromptRenderFilter
{
    ...
    private static void ProcessTextAnalysis(AnalyzeTextResult analysisResult)
    {
        ...
        {
            Console.WriteLine($"Category: {analysis.Category}. Severity: {analysis.Severity}");
